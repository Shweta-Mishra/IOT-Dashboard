            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
					...
					<li>
                      ...
                      <li>
                        <a href="#"><i class="fa fa-desktop"></i> Reports</a>
                    </li>
                    
                    <li>
                        <a href="#"><i class="fa fa-qrcode"></i> Trends</a>
                    </li>
                    
                    <li>
                        <a href="#"><i class="fa fa-table"></i> Prediction</a>
                    </li>
                    <li>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                             <small>Welcome to IOT Dashboard</small>
                        </h1>
						<ol class="breadcrumb">
  <li><a href="#">Home</a></li>
</ol>
                  ...
                  <br/>
                   <div class="row">
                    ...
                    <br/>
                    <br/>
                  <div id="gauge_div" style="width: 600px; height: 120px;"></div>
				<div id="mykpi"></kpi>
        ...
        <div class="modal-dialog">
            ...
            <form action="login">
              ...
              <!--      <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                     <button   id="cancel" type="submit" class="btn btn-primary" data-dismiss="modal">Login</button> -->
